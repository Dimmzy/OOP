...
public class GameLevel implements Animation {
    ...
    public void createPaddle() {
        ...
        Ship ship = new Ship(keyboard, new Point(SCREEN_WIDTH / 2 - levelInfo.paddleWidth() / 2,
    ...
    public void createBalls() {
        for (Velocity velocity : levelInfo.initialBallVelocities()) {
            Bullet newBull = new Bullet(new Point(SCREEN_WIDTH / 2, BALL_START_Y), 5, this.environment);
            newBull.setVelocity(velocity);
            this.ballCounter.increase(1);
            newBull.addToGame(this);
        }
    }
